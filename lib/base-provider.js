...
var BaseProvider = /** @class */ (function (_super) {
    ...
    BaseProvider.prototype._getInternalBlockNumber = function (maxAge) {
        return __awaiter(this, void 0, void 0, function () {
            var startId, result, err_1, reqTime, reqId;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(this._internalBlockNumberQuery && this._internalBlockNumberQuery.promise)) return [3 /*break*/, 7];
                        startId = this._internalBlockNumberQuery.id;
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this._internalBlockNumberQuery.promise];
                    case 4:
                        result = _a.sent();
                    ...
                    case 5:
                        err_1 = _a.sent();
                        logger.debug("Failed 'eth_blockNumber' query.", err_1);
                        return [3 /*break*/, 6];
                    case 6:
                    ...
                    case 7:
                        reqTime = getTime();
                        reqId = this._internalBlockNumberQuery ? this._internalBlockNumberQuery.id + 1 : 0;
                        this._internalBlockNumberQuery = {
                            id: reqId,
                            promise: (0, properties_1.resolveProperties)({
                                ...
                                if (networkError) {
                                    ...
                                    if (_this._internalBlockNumberQuery.id == reqId) {
                                        _this._internalBlockNumberQuery.promise = null;
                                    }
                                    throw networkError;
                                }
                                var respTime = getTime();
                                blockNumber = Math.max(bignumber_1.BigNumber.from(blockNumber).toNumber(), _this._maxInternalBlockNumber);
                                _this._maxInternalBlockNumber = blockNumber;
                                _this._setFastBlockNumber(blockNumber); // @TODO: Still need this?
                                return { blockNumber: blockNumber, reqTime: reqTime, respTime: respTime };
                            })
                        };
                        return [2 /*return*/, this._internalBlockNumberQuery.promise.then(function (block) { return block.blockNumber; })];
                }
            });
        });
    };
    ...
    BaseProvider.prototype._call = function (transaction, blockTag, attempt) {
        return __awaiter(this, void 0, void 0, function () {
            var txSender, result, data, sender, urls, urlsOffset, urlsLength, urlsData, u, url, calldata, callbackSelector, extraData, ccipResult, tx, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        error_7 = _a.sent();
                        if (error_7.code === logger_1.Logger.errors.SERVER_ERROR) {
                            throw error_7;
                        }
                        return [3 /*break*/, 5];
                    case 5:
    ...
    BaseProvider.prototype.getAvatar = function (nameOrAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var resolver, address, node, resolverAddress, avatar_1, error_10, name_1, _a, error_11, avatar;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        resolver = null;

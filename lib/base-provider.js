...
var BaseProvider = /** @class */ (function (_super) {
    ...
    BaseProvider.prototype._getInternalBlockNumber = function (maxAge) {
        return __awaiter(this, void 0, void 0, function () {
            var startId, result, error_5, reqTime, reqId;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        startId = this._internalBlockNumber.id;
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this._internalBlockNumber.promise];
                    case 4:
                        result = _a.sent();
                    ...
                    case 7:
                        reqTime = getTime();
                        reqId = this._internalBlockNumber ? this._internalBlockNumber.id + 1 : 0;
                        this._internalBlockNumber = {
                            ...
                            promise: (0, properties_1.resolveProperties)({
                                ...
                                if (networkError) {
                                    ...
                                    if (_this._internalBlockNumber.id == reqId) {
                        ...
                        return [2 /*return*/, this._internalBlockNumber.promise.then(function (block) { return block ? block.blockNumber : -1; })];
                }
            });
        });
    };
